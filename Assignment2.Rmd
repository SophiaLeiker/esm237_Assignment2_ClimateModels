...
ggplot()+geom_line(data = yrly_clim_e2_1_g_ssp126, aes(x=year(rtime), y=e2_1_g_ssp126, color="blue"))




# +labs(y="Concordia Station Temperature", x="Year")+ geom_smooth(method="lm")
