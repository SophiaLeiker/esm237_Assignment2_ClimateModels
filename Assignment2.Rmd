...
ncpath <- here("data")
ncname <- "tas_Amon_GISS-E2-1-G_1pctCO2_r1i1p1f1_gn_185001-190012.nc"  # CESM1 filename
...
ggplot(yrclim, aes(dt, Tann-273.15))+geom_point()+labs(y="[INSERT REGION HERE] Temperature", x="Year")+ geom_smooth(method="lm")
```
