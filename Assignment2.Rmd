...
time5 <- ncvar_get(e2_1_g_ssp585_2051_2100,"time")

#conconate time series
time=c(time1,time2,time3,time4,time5)

#get units for reference - it's the same for each object
tunits <- ncatt_get(e2_1_g_1850_1900,"time","units")

#tunits1 <- ncatt_get(ncin_e3sm1,"time","units")
#tunits2 <- ncatt_get(ncin_e3sm2,"time","unit")
...
tas_e2_1_g_ssp585_2051_2100 <- ncvar_get(e2_1_g_ssp585_2015_2050, "tas")
