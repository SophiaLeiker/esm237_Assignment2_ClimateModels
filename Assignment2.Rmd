...
ncpath <- here("data")
ncname <- "tas_historical_r1i1p3f1_1850-1900.nc"  # CESM1 filename
...
lats=which(lat >= 72.6 & lat <= 77.6) # insert lattitude and longitude readings here!
lons=which(lon >= 120.9 & lon <= 125.9)
