...
ggplot()+
  geom_line(data = yrly_clim_e2_1_g_ssp126, aes(x=1850:2100, y=e2_1_g_ssp126-273.15), color='blue')+  
  geom_line(data = yrly_clim_e2_1_g_ssp585, aes(x=1850:2100, y=e2_1_g_ssp585-273.15), color='red')+
  geom_line(data = yrly_clim_e2_1_h_ssp126, aes(x=1850:2100, y=e2_1_h_ssp126-273.15), color='green')+
  geom_line(data = yrly_clim_e2_1_h_ssp585, aes(x=1850:2100, y=e2_1_h_ssp585-273.15), color='pink')+
  labs(y="Concordia Station Temperature (degrees C)", x="Year", title = "Mean Surface Air Temperature Change in Concordia Station, Antartica")+ 
